...
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_51HvUGsHLhutnMt0vSTCs4pqlfOjEF4F7BXODPiZv69egJzuf1Fe1NrWb4xJrQrEwvds2KmMt0LiHy1tlpZSIQRiv00NqhGs7os")
STRIPE_PUB_KEY = os.environ.get("STRIPE_PUB_KEY", 'pk_test_51HvUGsHLhutnMt0vxGDg4igKlv8fvU69gJ5hwbaSSrIUwUlWEKuFzAuaXcP0xGBprXdbfpAOjdYqoYQXuIUUyRTl00P1aAfE6I')
...
STATIC_ROOT =  PROJECT_DIR /'static_cdn/static_root'
MEDIA_URL = '/media/'
